Pod::Spec.new do |s|
  ...
  s.source = {
    :http => "https://github.com/Buzzvil/Specs/raw/master/Framework/BuzzAdBenefit/2.0.0-beta.6/BuzzAdBenefit.zip"
  }
  ...
  s.vendored_frameworks = ['BuzzAdBenefit.framework', 'BuzzAdBenefitNative.framework', 'BuzzAdBenefitInterstitial.framework', 'BuzzAdBenefitFeed.framework', 'BuzzAdBenefitWebInterface.framework', 'BuzzAdBenefitWidget.framework']
end
