Pod::Spec.new do |s|
  ...
  s.version = "2.0.4-beta.4"
  s.license = { :type => "MIT", :file => "LICENSE" }
  s.author = "Buzzvil"
  s.homepage = "https://github.com/buzzvil/buzzad-benefit-sdk-publisher-ios"

  s.source = {
    :http => "https://github.com/Buzzvil/Specs/raw/master/Framework/BuzzAdBenefit/2.0.4-beta.4/BuzzAdBenefit.zip"
  }
  ...
  s.weak_frameworks = 'AppTrackingTransparency', 'StoreKit'
